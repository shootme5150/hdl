...
set_property  -quiet -dict {PACKAGE_PIN  G3} [get_ports tx_data_n[0]]                                    ; ## C03  FMC_HPC0_DP0_C2M_N        MGTHTXN2_229_G3
set_property  -quiet -dict {PACKAGE_PIN  G4} [get_ports tx_data_p[0]]                                    ; ## C02  FMC_HPC0_DP0_C2M_P        MGTHTXP2_229_G4
set_property  -quiet -dict {PACKAGE_PIN  H5} [get_ports tx_data_n[1]]                                    ; ## A23  FMC_HPC0_DP1_C2M_N        MGTHTXN1_229_H5
set_property  -quiet -dict {PACKAGE_PIN  H6} [get_ports tx_data_p[1]]                                    ; ## A22  FMC_HPC0_DP1_C2M_P        MGTHTXP1_229_H6
set_property  -quiet -dict {PACKAGE_PIN  F5} [get_ports tx_data_n[2]]                                    ; ## A27  FMC_HPC0_DP2_C2M_N        MGTHTXN3_229_F5
set_property  -quiet -dict {PACKAGE_PIN  F6} [get_ports tx_data_p[2]]                                    ; ## A26  FMC_HPC0_DP2_C2M_P        MGTHTXP3_229_F6
set_property  -quiet -dict {PACKAGE_PIN  K5} [get_ports tx_data_n[3]]                                    ; ## A31  FMC_HPC0_DP3_C2M_N        MGTHTXN0_229_K5
set_property  -quiet -dict {PACKAGE_PIN  K6} [get_ports tx_data_p[3]]                                    ; ## A30  FMC_HPC0_DP3_C2M_P        MGTHTXP0_229_K6
set_property  -quiet -dict {PACKAGE_PIN  M6} [get_ports tx_data_p[4]]                                    ; ## A34  FMC_HPC0_DP4_C2M_P        MGTHTXP3_228_M6
set_property  -quiet -dict {PACKAGE_PIN  M5} [get_ports tx_data_n[4]]                                    ; ## A35  FMC_HPC0_DP4_C2M_N        MGTHTXN3_228_M5
set_property  -quiet -dict {PACKAGE_PIN  P6} [get_ports tx_data_p[5]]                                    ; ## A38  FMC_HPC0_DP5_C2M_P        MGTHTXP1_228_P6
set_property  -quiet -dict {PACKAGE_PIN  P5} [get_ports tx_data_n[5]]                                    ; ## A39  FMC_HPC0_DP5_C2M_N        MGTHTXN1_228_P5
set_property  -quiet -dict {PACKAGE_PIN  R4} [get_ports tx_data_p[6]]                                    ; ## B36  FMC_HPC0_DP6_C2M_P        MGTHTXP0_228_R4
set_property  -quiet -dict {PACKAGE_PIN  R3} [get_ports tx_data_n[6]]                                    ; ## B37  FMC_HPC0_DP6_C2M_N        MGTHTXN0_228_R3
set_property  -quiet -dict {PACKAGE_PIN  N4} [get_ports tx_data_p[7]]                                    ; ## B32  FMC_HPC0_DP7_C2M_P        MGTHTXP2_228_N4
set_property  -quiet -dict {PACKAGE_PIN  N3} [get_ports tx_data_n[7]]                                    ; ## B33  FMC_HPC0_DP7_C2M_N        MGTHTXN2_228_N3
